...
vtkStandardNewMacro(PlaneWidget);

vtkCxxSetObjectMacro(PlaneWidget, PlaneProperty, vtkProperty);

PlaneWidget::PlaneWidget()
{
  this->State = PlaneWidget::Start;
  this->EventCallbackCommand->SetCallback(PlaneWidget::ProcessEvents);
...
void PlaneWidget::SetEnabled(int enabling)
{
  if (!this->Interactor)
  {
...
//------------------------------------------------------------------------------
void PlaneWidget::RegisterPickers()
{
...
void PlaneWidget::PrintSelf(ostream& os, vtkIndent indent)
{
...
void PlaneWidget::PositionHandles()
{
  double* o = this->PlaneSource->GetOrigin();
  double* pt1 = this->PlaneSource->GetPoint1();
  double* pt2 = this->PlaneSource->GetPoint2();
...
int PlaneWidget::HighlightHandle(vtkProp* prop)
{
...
void PlaneWidget::HighlightNormal(int highlight)
{
  if (highlight)
  {
    this->ValidPick = 1;
...
void PlaneWidget::HighlightPlane(int highlight)
{
  if (highlight)
  {
    this->ValidPick = 1;
...
void PlaneWidget::OnStartPinch()
{
  ...
  {
    this->State = PlaneWidget::Outside;
    return;
  }
  ...
  if (path != nullptr)
  {
    this->State = PlaneWidget::Pinching;
...
void PlaneWidget::OnPinch()
{
  if (this->State != PlaneWidget::Pinching)
  {
    return;
  }
...
void PlaneWidget::OnLeftButtonDown()
{
  int X = this->Interactor->GetEventPosition()[0];
  int Y = this->Interactor->GetEventPosition()[1];
  ...
  else
  {
    ...
    if (path != nullptr)
    {
      ...
      {
        this->State = PlaneWidget::Rotating;
        this->HighlightNormal(1);
      }
      else if (this->Interactor->GetControlKey())
      {
        this->State = PlaneWidget::Spinning;
        this->HighlightNormal(1);
      }
      else
      {
...
void PlaneWidget::OnLeftButtonUp()
{
  if (this->State == PlaneWidget::Outside || this->State == PlaneWidget::Start)
  {
    return;
  }
...
void PlaneWidget::OnMiddleButtonDown()
{
  int X = this->Interactor->GetEventPosition()[0];
  int Y = this->Interactor->GetEventPosition()[1];
  ...
  if (path != nullptr)
  {
    this->State = PlaneWidget::Pushing;
    this->HighlightPlane(1);
    this->HighlightNormal(1);
    this->HighlightHandle(path->GetFirstNode()->GetViewProp());
  }
...
void PlaneWidget::OnMiddleButtonUp()
{
  if (this->State == PlaneWidget::Outside || this->State == PlaneWidget::Start)
  {
    return;
...
void PlaneWidget::OnRightButtonDown()
{
  int X = this->Interactor->GetEventPosition()[0];
  int Y = this->Interactor->GetEventPosition()[1];
  ...
  if (path != nullptr)
  {
    this->State = PlaneWidget::Scaling;
    this->HighlightPlane(1);
    this->HighlightHandle(path->GetFirstNode()->GetViewProp());
  }
...
void PlaneWidget::OnRightButtonUp()
{
  if (this->State == PlaneWidget::Outside || this->State == PlaneWidget::Start)
  {
    return;
...
void PlaneWidget::OnMouseMove()
{
  ...
  // Process the motion
  if (this->State == PlaneWidget::Moving)
  {
    // Okay to process
    if (this->CurrentHandle)
    {
  ...
  else if (this->State == PlaneWidget::Scaling)
  {
    this->Scale(prevPickPoint, pickPoint, X, Y);
  }
  else if (this->State == PlaneWidget::Pushing)
  {
    this->Push(prevPickPoint, pickPoint);
  }
  else if (this->State == PlaneWidget::Rotating)
  {
    camera->GetViewPlaneNormal(vpn);
    this->Rotate(X, Y, prevPickPoint, pickPoint, vpn);
  }
  else if (this->State == PlaneWidget::Spinning)
  {
...
void PlaneWidget::MoveOrigin(double* p1, double* p2)
{
...
void PlaneWidget::MovePoint1(double* p1, double* p2)
{
  // Get the plane definition
  double* o = this->PlaneSource->GetOrigin();
  double* pt1 = this->PlaneSource->GetPoint1();
...
void PlaneWidget::MovePoint2(double* p1, double* p2)
{
  // Get the plane definition
  double* o = this->PlaneSource->GetOrigin();
  double* pt1 = this->PlaneSource->GetPoint1();
...
void PlaneWidget::MovePoint3(double* p1, double* p2)
{
  // Get the plane definition
  double* o = this->PlaneSource->GetOrigin();
  double* pt1 = this->PlaneSource->GetPoint1();
...
void PlaneWidget::Rotate(int X, int Y, double* p1, double* p2, double* vpn)
{
  double* o = this->PlaneSource->GetOrigin();
  double* pt1 = this->PlaneSource->GetPoint1();
  double* pt2 = this->PlaneSource->GetPoint2();
...
void PlaneWidget::Spin(double* p1, double* p2)
{
  // Mouse motion vector in world space
  double v[3];
  v[0] = p2[0] - p1[0];
...
void PlaneWidget::Translate(double* p1, double* p2)
{
...
void PlaneWidget::Scale(double* p1, double* p2, int vtkNotUsed(X), int Y)
{
  // Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
void PlaneWidget::Push(double* p1, double* p2)
{
  // Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
void PlaneWidget::CreateDefaultProperties()
{
  // Handle properties
...
void PlaneWidget::PlaceWidget(double bds[6])
{
  int i;
...
void PlaneWidget::SelectRepresentation()
{
  if (!this->CurrentRenderer)
  {
    return;
...
void PlaneWidget::SetOrigin(double x, double y, double z)
{
  this->PlaneSource->SetOrigin(x, y, z);
  this->PositionHandles();
}

void PlaneWidget::SetOrigin(double x[3])
{
  this->SetOrigin(x[0], x[1], x[2]);
}

double* PlaneWidget::GetOrigin()
{
  return this->PlaneSource->GetOrigin();
}

void PlaneWidget::GetOrigin(double xyz[3])
{
...
void PlaneWidget::SetPoint1(double x, double y, double z)
{
  this->PlaneSource->SetPoint1(x, y, z);
  this->PositionHandles();
}

void PlaneWidget::SetPoint1(double x[3])
{
  this->SetPoint1(x[0], x[1], x[2]);
}

double* PlaneWidget::GetPoint1()
{
  return this->PlaneSource->GetPoint1();
}

void PlaneWidget::GetPoint1(double xyz[3])
{
...
void PlaneWidget::SetPoint2(double x, double y, double z)
{
  this->PlaneSource->SetPoint2(x, y, z);
  this->PositionHandles();
}

void PlaneWidget::SetPoint2(double x[3])
{
  this->SetPoint2(x[0], x[1], x[2]);
}

double* PlaneWidget::GetPoint2()
{
  return this->PlaneSource->GetPoint2();
}

void PlaneWidget::GetPoint2(double xyz[3])
{
...
void PlaneWidget::SetCenter(double x, double y, double z)
{
...
// Description:
// Set the center of the plane.
void PlaneWidget::SetCenter(double c[3])
{
...
double* PlaneWidget::GetCenter()
{
  return this->PlaneSource->GetCenter();
}

void PlaneWidget::GetCenter(double xyz[3])
{
...
void PlaneWidget::SetNormal(double x, double y, double z)
{
...
// Description:
// Set the normal to the plane.
void PlaneWidget::SetNormal(double n[3])
{
...
double* PlaneWidget::GetNormal()
{
  return this->PlaneSource->GetNormal();
}

void PlaneWidget::GetNormal(double xyz[3])
{
  this->PlaneSource->GetNormal(xyz);
}

void PlaneWidget::GetPolyData(vtkPolyData* pd)
{
  pd->ShallowCopy(this->PlaneSource->GetOutput());
}

vtkPolyDataAlgorithm* PlaneWidget::GetPolyDataAlgorithm()
{
  return this->PlaneSource;
}

void PlaneWidget::GetPlane(vtkPlane* plane)
{
  if (plane == nullptr)
  {
    return;
...
void PlaneWidget::UpdatePlacement()
{
  this->PlaneSource->Update();
  this->PositionHandles();
}
