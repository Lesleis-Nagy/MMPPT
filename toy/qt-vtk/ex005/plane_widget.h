...
#ifndef MMPPT_TOY_QT_VTK_EX005_PLANE_WIDGET_H_
#define MMPPT_TOY_QT_VTK_EX005_PLANE_WIDGET_H_
...
class VTKINTERACTIONWIDGETS_EXPORT PlaneWidget : public vtkPolyDataSourceWidget
{
 public:
  /**
   * Instantiate the object.
   */
  static PlaneWidget* New();

 vtkTypeMacro(PlaneWidget, vtkPolyDataSourceWidget);
 ...
 private:
  ...
  void operator=(const PlaneWidget&) = delete;
};

VTK_ABI_NAMESPACE_END

#endif //MMPPT_TOY_QT_VTK_EX005_PLANE_WIDGET_H_
